            ...
            try:
                ...
                if seconds is None:
                    ...
                    if connection_error:
                        ...
                        # Hanya MTProtoSender yang mengurus reconnect.
                        # Mengganti sender dari sini ketika receive-loop-nya
                        # juga sedang reconnect pernah menghasilkan dua
                        # coroutine membaca StreamReader yang sama.
                        renewed = False
                    else:
                        renewed = False
